          ...
          <div className="absolute left-4 top-1/2 -translate-y-1/2 flex items-center gap-5">
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                ...
                className="p-2 rounded-full border border-[#d4af37]/40 text-[#d4af37] hover:bg-[#d4af37]/10 hover:scale-110 transition"
                aria-label="Call Nirvaana"
              >
                <Phone size={18} />
              </a>
            ...
            <div className="grid md:grid-cols-2 gap-16 items-start mb-24">
              ...
              <div className="bg-black/40 border border-red-500/30 rounded-3xl p-8 backdrop-blur-md">
                ...
                <p className="text-[#e8d9a8] leading-relaxed text-lg">
                  ...
                  We do not provide any sexual, escort, or inappropriate services of any kind.
